...
var SekindoClientDetections_URL = function (config) {
	...
	this.setInfo();
				...
				var urlDetObj = new SekindoClientDetections_URL({
					url: 'https://live.sekindo.com/live/liveView.php?s=100387&cbuster=[CACHE_BUSTER]&pubUrl=[PAGE_URL_ENCODED]&x=[WIDTH]&y=[HEIGHT]&vp_content=plembed1549gysjumpw&vp_template=6097&subId=[SUBID_ENCODED]&cbuster=1584225400',
					origQString: 's=100387&cbuster=[CACHE_BUSTER]&pubUrl=[PAGE_URL_ENCODED]&x=[WIDTH]&y=[HEIGHT]&vp_content=plembed1549gysjumpw&vp_template=6097&subId=[SUBID_ENCODED]',
					x: 300,
					y: 250,
					isSlider: false,
					isOutstream: false,
					...
					isAPI: false,
					debug: 0,
					ci: {"extra":{"osVersionMinor":0,"schemaVer":11,"os":"Windows","osVersionMajor":10,"deviceManufacturer":"","browser":"Firefox","browserVersionMajor":"73","deviceCodeName":"","deviceType":"desktop","deviceModel":"","osVersion":"10.0","browserType":"browser","browserVersion":"73.0","browserVersionMinor":"0"},"browser":"firefox","os":"windows","osVer":"","deviceType":"desktop"},
					geo: 'XX',
					dmaCode: 0,
					dynamicSetup: [],
					uuid: '5e6d5c783ddb9',
